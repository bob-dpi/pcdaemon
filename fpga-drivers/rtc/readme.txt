...
used with one of the PC power distribution cards, the RTC
...
RESOURCES:
time : the current time in the RTC chip. Use pcset to set
the time and pcget to retrieve it. The time format is:
...
pcset and pccat.  The format for the alarm time is:
    day hour:minute
Where 'day' is in the range 1 to 31 and is the month day
when the alarm is triggered.

state : the state of the alarm output.  Using pcset you can
set the state to:
