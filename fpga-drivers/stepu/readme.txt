...
current to 15 percent of full current.
    pcset stepu config half forward 40 15
    pcset stepu count 4000
    (sleep to let motor accelerate to 40 steps/sec)
    pcset stepu config half forward 80 15
    (sleep to let motor accelerate)
    pcset stepu config half forward 200 15
    (sleep or loop reading count until count < 2000)
    pcset stepu addstep 2000
